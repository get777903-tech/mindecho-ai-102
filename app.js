/* ==========================================================================
   MindEcho AI 2026 — Main Application Engine (mindecho-ai-102)
   100% Multilingual (RU, EN, HE), NDA Canvas Signing, MediaRecorder Voice, CustDev
   ========================================================================== */
...
const i18n = {
  ru: {
    ...
    m4_tag: "Превентивная терапия сна",
    ...
    label_mic_rec: "🎙 Запись вашего голоса / вопросов:",
    mic_press_text: "Нажмите микрофон для записи голоса",
    ...
    billing_annual: "Оплата за год -67% Скидка",
    ...
    pf_free_3: "✅ Медленная озвучка мужским тембром",
    ...
    pf_basic_4: "✅ Запись кликов в Google Таблицы",
    ...
    nda_title: "📜 Электронная подпись NDA",
    nda_sub: "Соглашение о неразглашении конфиденциальной информации (NDA)",
...
function logClickAnalytics(eventType, planName, priceAmount, extraData = {}) {
  ...
  console.log("📊 [MindEcho Analytics 102] Sending Payload to Google Sheets:", payload);
...
function registerServiceWorker() {
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('sw.js')
      .then(() => console.log("📱 [PWA 102] Service Worker registered"))
